...
"directionless" aka not biased to the forward direction, and more robust

Entity: name, x, y, movement_style, movement_speed, angle, 
        model (one crazy-ass class that handles the image and hitbox? we should discuss the possibility of deriving hitbox from sprite)
    ...
    Ship: health, health_max, weapons, weapon_current, buffs, buff_current, fire_rate_factor, affinity, invuln,  
          offense_factor, defense_factor, collision_damage, collision_detect, regen_health, regen_ammo,
        Player
        *Enemies*
